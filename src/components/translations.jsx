export const translations = {
  en: {
    ...
    attempts_balance: 'Attempts Balance',
    attempts_used: 'Attempts Used',
    buy_attempts: 'Buy Attempts',
    purchase_attempts: 'Purchase additional prediction attempts',
    one_time_purchase: 'One-time purchase',
    attempts_count: 'attempts',
    buy_now: 'Buy Now',
    starter_pack: 'Starter Pack',
    professional_pack: 'Professional',
    high_roller_pack: 'High Roller',

    // Crypto payment
    crypto_payment: 'Cryptocurrency Payment',
    select_crypto: 'Select cryptocurrency and network',
    payment_amount: 'Payment Amount',
    send_to_address: 'Send to this address',
    copy_address: 'Copy Address',
    address_copied: 'Address copied!',
    payment_instructions: 'Payment Instructions',
    instruction_1: 'Send exact amount to the address above',
    instruction_2: 'Use the correct network',
    instruction_3: 'Wait for confirmation (1-3 confirmations)',
    instruction_4: 'Attempts will be added automatically',
    network: 'Network',
    processing_time: 'Processing time',
    minutes: 'minutes',
    scan_qr: 'Scan QR Code',
    or_copy: 'or copy address manually',
  ...
  ru: {
    ...
    attempts_balance: 'Баланс попыток',
    attempts_used: 'Использовано попыток',
    buy_attempts: 'Купить попытки',
    purchase_attempts: 'Приобретите дополнительные попытки предсказаний',
    one_time_purchase: 'Разовая покупка',
    attempts_count: 'попыток',
    buy_now: 'Купить сейчас',
    starter_pack: 'Стартовый пакет',
    professional_pack: 'Профессиональный',
    high_roller_pack: 'Хай Роллер',

    // Crypto payment
    crypto_payment: 'Оплата криптовалютой',
    select_crypto: 'Выберите криптовалюту и сеть',
    payment_amount: 'Сумма платежа',
    send_to_address: 'Отправьте на этот адрес',
    copy_address: 'Копировать адрес',
    address_copied: 'Адрес скопирован!',
    payment_instructions: 'Инструкции по оплате',
    instruction_1: 'Отправьте точную сумму на адрес выше',
    instruction_2: 'Используйте правильную сеть',
    instruction_3: 'Дождитесь подтверждения (1-3 подтверждения)',
    instruction_4: 'Попытки будут добавлены автоматически',
    network: 'Сеть',
    processing_time: 'Время обработки',
    minutes: 'минут',
    scan_qr: 'Сканировать QR-код',
    or_copy: 'или скопируйте адрес вручную',
    payment_pending: 'Ожидание оплаты',
    waiting_confirmation: 'Ожидание подтверждения блокчейна',
